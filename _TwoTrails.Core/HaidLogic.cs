    ...
    public static class HaidLogic
    {
        ...
        public static string GenerateSummaryHeader(TtProjectInfo projectInfo, string projectFilePath)
        {
            ...
            sb.AppendLine(
                ...
                "**** AREA-ERROR CANNOT BE LESSENED OR DIVIDED BY TWO UNLESS STRICT CRITERIA IS APPLIED. (See https://github.com/FMSC-Measurements/TwoTrails/wiki/Meeting-Area-Error)\n\n" +
